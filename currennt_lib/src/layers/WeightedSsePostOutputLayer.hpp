...
#ifndef LAYERS_WEIGHTEDSSEPOSTOUTPUTLAYER_HPP
#define LAYERS_WEIGHTEDSSEPOSTOUTPUTLAYER_HPP
...
namespace layers {
    ...
    class WeightedSsePostOutputLayer : public PostOutputLayer<TDevice>
    {
    public:
        /**
         ...
         * Destructs the Layer
         */
        virtual ~WeightedSsePostOutputLayer();
...
#endif // LAYERS_WEIGHTEDSSEPOSTOUTPUTLAYER_HPP
